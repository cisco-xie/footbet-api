...
public enum GameType {
    ...
    LUCKYSB("LUCKYSB", "DX1,DX2,DX3,DX4,DX5,DX6,DX7,DX8,DX9,DX10,DS1,DS2,DS3,DS4,DS5,DS6,DS7,DS8,DS9,DS10,GDX,GDS,LH1,LH2,LH3,LH4,LH5,B1,B2,B3,B4,B5,B6,B7,B8,B9,B10,GDX,GDS,GYH", "极速飞艇"),
