...
public class ThreadPoolMonitor {
     ...
     */
    public ThreadPoolMonitor(ThreadPoolExecutor executor, long periodSeconds) {
        this.executor = executor;
        this.scheduler = Executors.newSingleThreadScheduledExecutor(r ->
                new Thread(r, "ThreadPoolMonitor-" + executor.getThreadFactory().newThread(() -> {}).getName()));
    ...
    private void printStatus() {
        ...
        log.info("线程池状态监控 - 名称: {}, 池大小: {}, 活跃线程: {}, 队列长度: {}, 完成任务数: {}, 总任务数: {}, 拒绝任务数: {}",
                executor.toString(), poolSize, activeCount, queueSize, completedTaskCount, totalTaskCount, rejectedTasks);
    }
}
