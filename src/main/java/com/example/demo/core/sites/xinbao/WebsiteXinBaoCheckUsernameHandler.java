...
public class WebsiteXinBaoCheckUsernameHandler implements ApiHandler {
    ...
    @Autowired
    public WebsiteXinBaoCheckUsernameHandler(OkHttpProxyDispatcher dispatcher, WebsiteService websiteService, ApiUrlService apiUrlService) {
    ...
    public String buildRequest(JSONObject params) {
        ...
        return String.format("p=mem_chk&uid=%s&ver=%s&langx=zh-cn&username=%s&chk_name=%s",
                params.getStr("uid"),
                Constants.VER,
                username,
                chkName
