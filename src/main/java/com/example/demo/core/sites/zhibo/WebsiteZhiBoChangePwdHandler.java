 ...
 */
@Component
public class WebsiteZhiBoChangePwdHandler implements ApiHandler {
    private final WebsiteService websiteService;
    private final ApiUrlService apiUrlService;

    @Autowired
    public WebsiteZhiBoChangePwdHandler(WebsiteService websiteService, ApiUrlService apiUrlService) {
    ...
    public HttpEntity<String> buildRequest(JSONObject params) {
        ...
        body.putOpt("oldPassword", params.getStr("oldPassword"));
        body.putOpt("newPassword", params.getStr("newPassword"));
        body.putOpt("confirmPassword", params.getStr("chgPassword"));
    ...
    public JSONObject parseResponse(JSONObject params, HttpResponse response) {
        ...
        if (!responseJson.getBool("success", false)) {
            ...
            responseJson.putOpt("msg", "密码更改失败");
            return responseJson;
        }
        ...
        responseJson.putOpt("msg", "密码更改成功");
        return responseJson;
    }
