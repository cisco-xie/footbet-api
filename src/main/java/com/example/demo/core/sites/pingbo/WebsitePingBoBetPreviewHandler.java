...
public class WebsitePingBoBetPreviewHandler implements ApiHandler {
    ...
    @Autowired
    public WebsitePingBoBetPreviewHandler(OkHttpProxyDispatcher dispatcher, WebsiteService websiteService, ApiUrlService apiUrlService) {
    ...
    public String buildRequest(JSONObject params) {
        ...
        selections.putOpt("oddsFormat", params.getInt("oddsFormatType"));
