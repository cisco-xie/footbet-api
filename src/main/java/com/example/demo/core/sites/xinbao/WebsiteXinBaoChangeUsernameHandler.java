...
public class WebsiteXinBaoChangeUsernameHandler implements ApiHandler {
    ...
    @Autowired
    public WebsiteXinBaoChangeUsernameHandler(WebsiteService websiteService, ApiUrlService apiUrlService) {
...
//        headers.add("cookie", cookies);
        ...
        // 构造请求体
        String requestBody = String.format("p=chg_passwd_safe&uid=%s&ver=%s&langx=zh-cn&username=%s&chk_name=%s",
                params.getStr("uid"),
                Constants.VER,
                username,
                chkName
