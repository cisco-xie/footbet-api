...
public class WebsiteXinBaoChangePwdHandler implements ApiHandler {
    ...
    @Autowired
    public WebsiteXinBaoChangePwdHandler(WebsiteService websiteService, ApiUrlService apiUrlService) {
...
//        headers.add("cookie", cookies);
        ...
        // 构造请求体
        String requestBody = String.format("p=chg_newpwd&uid=%s&ver=%s&langx=zh-cn&username=%s&new_password=%s&chg_password=%s",
                params.getStr("uid"),
                Constants.VER,
                username,
                newPassword,
