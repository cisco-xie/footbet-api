 ...
 */
@Component
public class WebsiteZhiBoPreferencesHandler implements ApiHandler {
    private final WebsiteService websiteService;
    private final ApiUrlService apiUrlService;

    @Autowired
    public WebsiteZhiBoPreferencesHandler(WebsiteService websiteService, ApiUrlService apiUrlService) {
    ...
    public HttpEntity<String> buildRequest(JSONObject params) {
        ...
        body.putOpt("acceptHigherOdds", false);
        body.putOpt("accountTier", new JSONObject().putOpt("tierId", 2));
        body.putOpt("defaultStake", 0);
        body.putOpt("locale", "zh_CN");
        body.putOpt("oddsFormat", params.getStr("oddsFormatType"));
        body.putOpt("placeMaxBet", false);
        body.putOpt("timeZone", 8);
        body.putOpt("wagerShowFormat", 1);
    ...
    public JSONObject parseResponse(JSONObject params, HttpResponse response) {
        ...
        if (!responseJson.getBool("success", false)) {
            ...
            responseJson.putOpt("msg", "更换偏好设置失败");
            return responseJson;
        }
        ...
        responseJson.putOpt("msg", "成功更换偏好设置");
        return responseJson;
    }
